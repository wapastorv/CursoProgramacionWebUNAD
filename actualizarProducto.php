  ...
  <body>
    <header>
        ...
        <main class="flex-shrink-0">
            <div class="container">
                <title>Formulario de Actualizacion del producto</title>
  </head>
  <body>
<div class="container">
  <h1>Formulario de Actualizacion del producto</h1>
<p class="lead">
                    Este Formulario nos servira para Actualizar el producto registrado
                </p>
